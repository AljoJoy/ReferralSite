...
<head>
    ...
    <title>Referral Site</title>
    <link rel="icon" type="image/x-icon" href="<?php echo e(url('/images/referral_logo.png')); ?>">
    <!-- Fonts -->
    ...
    <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            <div class="flex justify-center">
                <img src="<?php echo e(url('/images/referral_logo.png')); ?>" alt="logo">
            </div>

            <div class="mt-16">
                <div class="flex flex-col justify-center">
                    <a href="#" class="text-center text-gray-500 dark:text-white text-5xl ">Referral Site</h1>
                </div>
            </div>
...
</html><?php /**PATH C:\xampp\htdocs\ReferralSite\ReferralSite\resources\views/welcome.blade.php ENDPATH**/ ?>